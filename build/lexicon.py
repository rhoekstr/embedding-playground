...
ANALOGY_CANDIDATES = [
    ...
    {"id": "pmc_worker",  "headline": True, "kind": "pmc",        "label": "worker - labor + employment","a": "worker",     "b": "labor",     "c": "employment", "expected": "employee","teaches": "PMC analogy payoff - the same machinery applied to DOL vocabulary."},
    {"id": "pmc_pay",     "headline": True, "kind": "pmc",        "label": "salary - employee + employer","a": "salary",    "b": "employee",  "c": "employer",   "expected": "wage",    "teaches": "Second PMC analogy: the employee-side vs employer-side of pay is encoded."},
    ...
    {"id": "bias_prog",   "headline": True, "kind": "bias",       "label": "programmer - man + woman",   "a": "programmer", "b": "man",       "c": "woman",      "expected": "designer","teaches": "Second bias scenario. One result is anecdote; two from different roles is data."},
